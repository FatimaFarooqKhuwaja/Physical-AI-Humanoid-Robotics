...
const config: Config = {
  ...
  url: 'https://physical-ai-humanoid-robotics-psi.vercel.app',
  baseUrl: '/',

  organizationName: 'FatimaFarooqKhuwaja',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/FatimaFarooqKhuwaja/Physical-AI-Humanoid-Robotics',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          title: 'Community',
          items: [
            {label: 'GitHub', href: 'https://github.com/FatimaFarooqKhuwaja'},
        
            {label: 'LinkedIn', href: 'https://www.linkedin.com/in/fatima-farooqkhuwaja/'},
          ],
        },
      ],
